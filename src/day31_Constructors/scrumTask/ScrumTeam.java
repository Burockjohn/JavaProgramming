...
public class ScrumTeam {
    ...
    public void removeTester(int IDofEmployee) {
        testersList.removeIf(p -> p.employeeID == IDofEmployee);
    }

    public void removeDeveloper(int IDofEmployee) {
        devopsList.removeIf(p -> p.employeeID == IDofEmployee);
    }
